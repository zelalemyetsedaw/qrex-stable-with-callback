...
export function render(qrData, options, cb) {
    ...
    const inverse = !!(options === null || options === void 0 ? void 0 : options.inverse);
    const lineSetup = (options === null || options === void 0 ? void 0 : options.inverse) ? lineSetupInverse : lineSetupNormal;
