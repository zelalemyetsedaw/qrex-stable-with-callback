...
import { NUMERIC as _NUMERIC, ALPHANUMERIC as _ALPHANUMERIC, BYTE as _BYTE, KANJI as _KANJI, BYTE_KANJI, } from "./regex.js";
...
function buildSingleSegment(data, modesHint) {
    ...
    if (mode !== BYTE && mode.bit < bestMode.bit) {
        throw new Error(`"${data}" cannot be encoded with mode ${toString(mode)}.
