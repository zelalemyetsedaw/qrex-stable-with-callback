import { ErrorCorrectionLevelBit } from "../types/qrex.type.js";
 ...
 */
export function getTotalCodewordsCount(version:number, errorCorrectionLevel:ErrorCorrectionLevelBit):number|undefined {
  switch (errorCorrectionLevel) {
    case L:
